...
foreach ($computers as $computer) {
    ...
    echo "<td>
            ...
            <svg xmlns='http://www.w3.org/2000/svg' width='23' height='23' fill='currentColor' class='bi bi-pencil-square editbtn' data-id='" . $computer['idob'] . "' data-toggle='modal' data-target='#editModal' viewBox='0 0 16 16'>
