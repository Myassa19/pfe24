...
include_once 'ComputerModel.php'; 
...
foreach ($computers as $computer) {
    ...
    echo "<td>
            <div class=' mx-3 mb-3 d-flex align-items-center'>
                ...
                <svg xmlns='http://www.w3.org/2000/svg' width='23' height='23' fill='currentColor' class='bi bi-trash3-fill delete-button' data-id='" . $computer['idob'] . "' viewBox='0 0 16 16'>
